...
sns.relplot(x='overall', y='value_eur', hue='age', palette='viridis', size="age", sizes=(15, 200), aspect=2, data=Fifa_Top_250_DF)
...
foot = ['Left', 'Right']
data = Fifa_Top_250_DF.query('preferred_foot in @foot')
...
#fig.show()
Unique_Clubs_DF = Fifa_Top_250_DF.club_name.unique()[:20]
...
sns.lmplot(x='skill_ball_control', y='skill_dribbling', data=Fifa_Top_250_DF[:1000], col='preferred_foot')
#plt.show()
